...
// Checkout Function (Send order directly to WhatsApp)
const WHATSAPP_NUMBER = '94768427705'; // Sri Lanka country code (94) + number without leading 0
...
function processCheckout() {
  ...
  const checkoutBtn = document.getElementById('checkoutBtn');
  if (checkoutBtn) {
    checkoutBtn.innerHTML = 'Opening WhatsApp...';
    checkoutBtn.disabled = true;
  }
  ...
  const subtotalAmount = document.getElementById('subtotal').textContent;

  // Build a clean, auto-generated English WhatsApp message
  const message =
`Hello FEARLESS! I would like to place the following order:
...
Please confirm my order and let me know the available payment methods. Thank you!`;
